...
class Project(models.Model):
    ...
    total_fcte_amount_expected = models.FloatField(editable=False, default=0)
    total_compensation_expected = models.FloatField(null=True, blank=True)
    total_compensation_executed = models.FloatField(null=True, blank=True)
    total_compensation_pending = models.FloatField(null=True, blank=True)
    total_compensation_overdue = models.FloatField(null=True, blank=True)
    ...
    nota_dotacao = models.CharField(max_length=100, null=True, blank=True)
    ptres = models.CharField(max_length=100, null=True, blank=True)
    ugr = models.CharField(max_length=100, null=True, blank=True)
    funding_source = models.CharField(max_length=100, null=True, blank=True)
    detailed_nature = models.CharField(max_length=8, null=True, blank=True)
    internal_plan = models.CharField(max_length=100, null=True, blank=True)
    internal_plan_name = models.CharField(max_length=100, null=True, blank=True)
    ...
    def calculate_compensation_totals(self):
        ...
        self.total_fcte_amount_expected = expected
        self.save()
